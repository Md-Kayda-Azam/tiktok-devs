...
import logo from "../../_asset/Icon/logo_tiktok.png";
import "./Header.scss";
...
const Header = ({
  ...
  return (
    <>
      {/* {`${pro ? pro : "header-wraper"} `} */}
      <div className={`tik-header ${sssdswa}`}>
        <div className={`header-wraper ${pro}`}>
          <div className={`logo ${tra}`}>
            <img src={logo} alt="" />
          </div>

          <div className={`header-menu ${hme}`}>
            <div className={`search-menu ${input_t}`}>
            ...
            <div className={`menu ${menu_t}`}>
              {!swerf && (
                <>
                  ...
                  <div className="item create-effects-message-toltip">
                    <a href="#">
                      <svg
                    ...
                    <div className={`create-effects-message ${mess}`}>
                      <div className="up-a"></div>
                      <span>Messages</span>
                    </div>
                  </div>
                  <div className="item create-effects-inbox-toltip">
                    <a href="#">
                      <svg
                    ...
                    <div className={`create-effects-inbox ${inbox}`}>
                      <div className="up-a"></div>
                      <span>Inbox</span>
                    </div>
                  </div>
                  <div className={`item handle-setting-popul-list `}>
                    <a href="#">
                      <img
                        src="https://i0.wp.com/sguru.org/wp-content/uploads/2017/04/WhatsApp-DP-for-Boys-17.jpg?resize=500%2C527&ssl=1"
                        alt=""
                      />
                    </a>
                    <div className={`home-profile-info ${profileShow}`}>
                      <div class="up-a"></div>
                      <div className="item">
                        <svg
                          class="css-g0144v"
              ...
              {swerf && (
                <>
                  ...
                  <div className="create-Effect-btn">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 22 22"
                  ...
                  <div className="info-pew">
                    <svg
                      class="css-lgo5n0-StyledEllipsisVertical e13wiwn65"
                      width="1em"
                      data-e2e=""
                      height="1em"
                      viewBox="0 0 48 48"
